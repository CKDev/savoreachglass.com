...
Autocompleter.Base.prototype = {
  ...
  updateElement: function(selectedElement) {
    ...
    if (lastTokenPos != -1) {
      ...
      var whitespace = this.element.value
        .substr(lastTokenPos + 1)
        .match(/^\s+/);
...
Object.extend(
  Object.extend(Ajax.Autocompleter.prototype, Autocompleter.Base.prototype),
  {
...
Ajax.InPlaceEditor.prototype = {
  initialize: function(element, url, options) {
    ...
    this.originalBackground = Element.getStyle(
      this.element,
      "background-color"
    );
...
Object.extend(
  Ajax.InPlaceCollectionEditor.prototype,
  Ajax.InPlaceEditor.prototype
);
    ...
    if (!this.cached_selectTag) {
      ...
      collection.each(
        function(e, i) {
          ...
          if (
            typeof this.options.value == "undefined" &&
            (e instanceof Array
