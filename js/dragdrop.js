...
Draggable.prototype = {
  initialize: function(element) {
    var defaults = {
      ...
      endeffect: function(element) {
        var toOpacity =
          typeof element._opacity == "number" ? element._opacity : 1.0;
  ...
  initDrag: function(event) {
    if (
      typeof Draggable._dragging[this.element] != "undefined" &&
      ...
      if (typeof this.options.snap == "function") {
        ...
        if (this.options.snap instanceof Array) {
          p = p.map(
            function(v, i) {
              return (
                Math.round(v / this.options.snap[i]) * this.options.snap[i]
              );
            }.bind(this)
          );
        } else {
